...
SFX = [
 ...
 ("jump","騎士起跳",0.6,0.35,1,False,
  "Armored knight jumping off the ground, quick hydraulic push from a prosthetic leg with a short cloth and armor rustle, upward and light"),
 ("land","騎士落地",0.7,0.42,2,False,
  "Armored knight landing on packed dirt, solid double thud of boots with a metallic armor settle and a small servo absorb, weighty but not heavy"),
...
MUSIC = [
 ...
 ("founding_theme","建國點火儀式",14000,False,
  "Founding stinger, a low resonant swell rising into a warm bell motif with plucked strings, the moment a refuge is born, hopeful and ceremonial, ends on a sustained chord"),
